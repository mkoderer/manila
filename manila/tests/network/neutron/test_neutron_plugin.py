...
class NeutronBindNetworkPluginTest(test.TestCase):
    ...
    def test_allocate_network_multi_segment(self):
        ...
        fake_network_allocation_multi_updated = \
            dict(fake_network_allocation_multi)
    ...
    def test__get_port_create_args(self, neutron_binding_profiles,
        ...
        create_args = instance._get_port_create_args(
...
class NeutronBindSingleNetworkPluginTest(NeutronBindNetworkPluginTest,
    ...
    @mock.patch.object(
        plugin.NeutronNetworkPlugin, "allocate_network",
        mock.Mock(return_value=['port1', 'port2']))
    def test_allocate_network(self):
        ...
        instance._wait_for_ports_bind.assert_called_once_with(
            self.context, ['port1', 'port2'], share_server,
