...
from manila.share.drivers.container import container
...
class ContainerShareDriverTestCase(test.TestCase):
    ...
    def setUp(self):
        ...
        self._driver = container.ContainerShareDriver(
    ...
    def test_create_share(self):
        ...
        self.mock_object(self._driver.container, 'execute_sync')
    ...
    def test_delete_share(self):
        ...
        self._driver.container.execute_sync.assert_called_with(
            'manila_fake',
    ...
    def test_update_access_access_rules_ok(self):
        ...
        self._driver.update_access(self._context, self.share,
                                   ...
                                   [], [], {"id": "fake"})
        helper.update_access.assert_called_with('fakeshareid', 'manila_fake',
                                                [{'access_level': 'rw'}],
                                                [], [])
    ...
    def test__teardown_server(self):
        ...
        self.mock_object(self._driver.container, "stop_container",
                         mock.Mock())
